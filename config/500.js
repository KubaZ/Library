...
function normalizeErrors (errorToLog, errorToJSON, errorsToDisplay) {
    var i;
    ...
    for (i in errorsToDisplay) {
        ...
        if (errorsToDisplay.hasOwnProperty(i)) {
...
module.exports[500] = function serverErrorOccurred(errors, req, res) {
    ...
    normalizeErrors(errorToLog, errorToJSON, errorsToDisplay);
